...
#define  PANEL_RING                       4       /* control type: ring, callback function: HL1101_y_axis */
...
#define  PANEL_RING_HORIZONTAL            22      /* control type: ring, callback function: on_horizontal */
...
int  CVICALLBACK HL1101_y_axis(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
int  CVICALLBACK on_horizontal(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
