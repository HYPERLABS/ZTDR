<distribution version="13.0.2" name="ZTDR" type="MSI">
	...
	<msi GUID="{19A16F8B-B0A6-4056-BF6C-E22260352FB7}">
		<general appName="ZTDR" outputLocation="d:\Dropbox\Documents\HYPERLABS\GitHub\ZTDR\Install\cvidistkit.ZTDR_2.0.8" relOutputLocation="..\Install\cvidistkit.ZTDR_2.0.8" outputLocationWithVars="d:\Dropbox\Documents\HYPERLABS\GitHub\ZTDR\Install\cvidistkit.%name_%version" relOutputLocationWithVars="..\Install\cvidistkit.%name_%version" upgradeBehavior="1" autoIncrement="true" version="2.0.8">
		...
		<dirs appDirID="104">
			...
			<installDir name="ZTDR" dirID="102" parentID="103" isMSIDir="false" visible="true" unlock="false"/>
			<installDir name="HYPERLABS" dirID="103" parentID="7" isMSIDir="false" visible="true" unlock="false"/>
			<installDir name="ZTDR" dirID="104" parentID="100" isMSIDir="false" visible="true" unlock="false"/></dirs>
		<files>
		...
		<shortcuts>
			<shortcut name="ZTDR" targetFileID="0" destDirID="102" cmdLineArgs="" description="" runStyle="NORMAL"/></shortcuts>
		<mergemodules/>
		<products>
		...
		<buildData progressBarRate="4.128403181983922">
			<progressTimes>
				<Begin>0.000000000000000</Begin>
				<ProductsAdded>0.055679064011054</ProductsAdded>
				<DPConfigured>0.541059931533639</DPConfigured>
				<DPMergeModulesAdded>1.026497064283535</DPMergeModulesAdded>
				<DPClosed>1.992470364714731</DPClosed>
				<DistributionsCopied>2.105222408328033</DistributionsCopied>
				<End>24.222440394483122</End></progressTimes></buildData>
	</msi>
</distribution>
